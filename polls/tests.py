...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        The detail view of question with the pub_date in the future
        should return 404 not found.
        """

        future_question = create_question(
            "Future question.", days_offset_from_now=30)
    ...
    def test_past_question(self):
        """
        The detail view of question with the pub_date in the past should
        return the question text and options
        """

        past_question = create_question(
            "Past question.", days_offset_from_now=-1
        )
